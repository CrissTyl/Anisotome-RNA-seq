...
#SBATCH --job-name A_lyallii_old_root_R      # you can give your job a name for easier identification (same as -J)
...
srun fastqc /mnt/scratch/crisstyl/anisoscript/data/A_lyallii_old_root_R.fastq -o /mnt/scratch/crisstyl/anisoscript/results -f fastq
