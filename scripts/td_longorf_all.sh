...
#SBATCH --job-name A.lyallii_longorf      # you can give your job a name for easier identification (same as -J)
...
TransDecoder.LongOrfs -t /mnt/scratch/crisstyl/anisoscript/all_res/transcriptome.fasta
