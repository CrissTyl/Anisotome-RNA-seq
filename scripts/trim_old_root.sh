...
#SBATCH --job-name A_lyallii_old_root_F      # you can give your job a name for easier identification (same as -J)
...
java -jar $EBROOTTRIMMOMATIC/trimmomatic-0.36.jar PE -threads 12 -phred33 ../data/A_lyallii_old_root_F.fastq ../data/A_lyallii_old_root_R.fastq \
../results/old_root_F_pair.fastq ../results/old_root_F_unpair.fastq ../results/old_root_R_pair.fastq ../results/old_root_R_unpair.fastq \
