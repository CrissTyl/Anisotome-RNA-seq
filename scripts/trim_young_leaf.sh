...
THREAD=12
FORWARD=../data/A_lyallii_young_leaf_F.fastq
REVERSE=../data/A_lyallii_young_leaf_R.fastq

java -jar $EBROOTTRIMMOMATIC/trimmomatic-0.36.jar PE -threads 12 -phred33 $FORWARD $REVERSE \
../results/young_leaf_F_pair.fastq ../results/young_leaf_F_unpair.fastq ../results/young_leaf_R_pair.fastq ../results/young_leaf_R_unpair.fastq \
