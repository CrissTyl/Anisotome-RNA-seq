...
DB_INPUT=/mnt/scratch/crisstyl/anisoscript/BLAST/transPTs_BLASTvUniProt.fasta
...
E_VALUE=1e-10
BLAST_OUTPUT=/mnt/scratch/crisstyl/anisoscript/all_res/blast_all_trnPT_out
